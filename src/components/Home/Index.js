      ...
      <section className='home-main'>
          ...
          <div className='about'>
            <h2 className='white welcome'>
             ...
             <h2 className='white'>Arada is is a chatting platform that brings you closer.
              ...
              <div className='mob-arada-flex' >
              <small class="orange mob-arada-desc">Arada is someone who is flexable ,hard worker, and who can adopt to new things.  </small>
          ...
          <div className="more-info" >
            <h1 className='logo-aa border'>አrada</h1>
             <h2 className='white mob'> Connect with Every one. </h2> 
          </div>
          </div>
